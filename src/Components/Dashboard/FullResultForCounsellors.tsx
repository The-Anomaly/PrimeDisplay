...
class FullResultForCounsellors extends React.Component<React.Props<any>> {
  state: State = {
    fullname: "",
    client: [],
    careerbussines: [],
  ...
  componentDidMount() {
    ...
    axios
      .get<any, AxiosResponse<any>>(
        `${API}/paiddashboard/${this?.props?.match?.params?.email}`,
        {
...
export default FullResultForCounsellors;
