          ...
          <Col md={10} sm={12} className="prm">
            ...
            <Row>
              <Col md={12} className="firstqq">
               ...
               <div><span className="ref_btn">Get referral link </span></div>
              ...
              <Modal show={state.isOpen} size={"lg"} centered={true} className="referral_modal">
                  <Container>
                     ...
                     <div className="modal_input">
                         <input type="text" size={30} className=" form-control ref_input"/>
