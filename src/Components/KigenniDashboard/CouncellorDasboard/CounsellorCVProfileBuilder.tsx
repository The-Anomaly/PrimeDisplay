...
class CounsellorCVProfileBuilder extends React.Component {
  state: any = {
    fullname: "",
    references: [],
    experiences: [],
      ...
      .then((response) => {
        if (response.status === 200) {
          ...
          if (response.data.new_user) {
            self.props.history.push("/counsellorprofilebuilderedit");
          }
        }
      })
      .catch((error) => {
        ...
        <Container fluid={true} className="contann122">
          ...
          <Row>
            ...
            <Col md={10} sm={12} className="prm">
              <CounsellorDashboardNav title="Profile Builder" />
              <Row>
...
export default CounsellorCVProfileBuilder;
