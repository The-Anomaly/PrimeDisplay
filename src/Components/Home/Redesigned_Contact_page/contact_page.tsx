             ...
             <Container>
                 <Row>
                     <Col md={12} className="contact_us_div">
                         ...
                         <p>We are always excited to hear from you.<br></br>Have questions or enquiries, need to integrate 
                         clarity to your system or organizations?<br></br>Get in contact with our experts let us set things in motion.
                         </p>
                    </Col>
                 </Row>
             </Container>
                 ...
                 <Row className="margintop">
                     <Col md={4}>
                         <form className="contactform ">
                             ...
                             <input type="text" placeholder="Your Name" className="contact_info form-control" /><br></br>
                             <input type="text" placeholder="Your Email" className="contact_info form-control"/><br></br>
                             <textarea placeholder="Your Message" cols={30} rows={10} className="contact_info form-control"/>
                            <div> <span className="contact_btn">Send </span></div>
                         </form>
                     </Col>
                     <Col md={8}>
                  ...
                  <Row>
                      <Col md={12}>
                          <div className="help-section">
                              <h4>THINK THIS IS YOU? LET'S HELP YOU FIX THAT.<br></br>TAKE THE FREE ASSESMENT</h4>
