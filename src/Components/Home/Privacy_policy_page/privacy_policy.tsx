          ...
          <Col md={11} className="policy-content">
            <Card className="policy-card">
              ...
              <Card.Body>
                ...
                "Us" or "Our" in this Agreement) refers to Yudimy Services Ltd,
                3 Samuel Street, Ogudu, Lagos.
                <br></br>
                ...
                processes the data on behalf of Yudimy. It refers to third-party
                companies or individuals employed by Yudimy to facilitate the
                Service, to provide the Service on behalf of Yudimy, to perform
                services related to the Service or to assist Yudimy in analysing
                how the Service is used.
                <br></br>
                -Third-party Social Media Service could be any website or social
                network website in which a User can log in or create an account
                to use the Service.
                <br></br>
                ...
                more targeted and relevant ads to potential customers.<br></br>
                <br></br>
                ...
                <br></br>
                <strong>
                  When does Yudimy use end user information from third parties?
                </strong>
                <br></br>
                <br></br>
                ...
                <br></br>
                <strong>
                  When does Yudimy use customer information from third parties?
                </strong>
                <br></br>
                <br></br>
                ...
                non-personal information to our successors-in-interest.<br></br>
                <br></br>
                <br></br>
                ...
                <br></br>
                <br></br>
                Yudimy will collect personal information that you submit to us.
                ...
                Yudimy to you and fulfill the purposes described in this policy.
                ...
                Yudimy or guarantee that your information on the Service may not
                ...
                <br></br>
                <br></br>
                Yudimy is incorporated in Nigeria. Information collected via our
                ...
                <br></br>
                <br></br>
                If you are a Yudimy worker or applicant, we collect information
                ...
                under common control with Yudimy, whether by ownership or
                ...
                govern this Agreement and your use of the website/app. Your use
                of the website/app may also be subject to other local, state,
                ...
                <br></br>
                <br></br>
                Yudimy uses "Cookies" to identify the areas of our website that
                ...
                ("Third- Party Services"). You acknowledge and agree that Yudimy
                ...
                thereof. Yudimy does not assume and shall not have any liability
                ...
                <br></br>
                <br></br>
                Invisible reCAPTCHA analyzes activity on a job post (e.g. mouse
                movements and typing patterns) to determine if a user is a
                robot. Invisible reCAPTCHA service may collect information from
                Your device. The information gathered by Invisible reCAPTCHA is
                ...
                for security purposes. The information gathered by Google Places
                is held in accordance with the Privacy Policy of Google
                <br></br>
                <br></br>
                <br></br>
                Information Regarding Your Data Protection Rights Under General
                ...
                described in this Privacy Policy, depends on the information we
                ...
                have collected about you.<br></br>
                -Right to Equal Service. We will not discriminate against you if
                you exercise your privacy rights.<br></br>
