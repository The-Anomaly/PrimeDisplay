...
const PersonalityType: React.FunctionComponent<IAppProps> = (props:any) => {
                  ...
                  <Col md={10} className="shiftcent">
                    <div className="dashboardwrap">
                      <dashboardContext.Provider value={{...state,updateState}}>
                        <Sidebar career_fitness={false} personality={true} result={result}/>
                        <MainBody title="PERSONALITY TYPE" result={result}/>
